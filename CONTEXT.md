...
> Phase 4.1 产出 DESIGN.md v1.4（11 节：Visual Theme → Imagery），设计基调已锁定。以下为摘要，完整规范见根目录 DESIGN.md 及 src/styles/。

### 三画布系统

- **Home (Sci-Fi Editorial)**：冷调深黑画布 `#0A0A0C`，Klein Blue `#002FA7` 为唯一品牌色，粒子星座为签名视觉锚点。Meta 结构 + Dala/Monopo 气质
