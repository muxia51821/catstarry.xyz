...
export const homePlanetKeys = ['about', 'feed', 'blog', 'projects', 'learn'] as const;
  ...
  planets: {
    about: {
      ...
      focus: {
        ...
        title: '木下',
        description: '个人世界的轨道与镜头，记录成长、选择，以及那些值得长期留下的事。',
        notes: ['天下断无易处之境遇', '人生哪得空闲之光阴'],
        action: '',
      },
    },
    feed: {
      ...
      focus: {
        ...
        notes: ['碎碎念与剪藏构成此刻。', '写作、学习与项目的里程碑汇入同一条来时路。'],
        action: 'ENTER FEED',
      },
    },
    blog: {
      ...
      focus: {
        ...
        title: 'BLOG',
        description: '把尚未想清的问题写深一些，也把值得保留的认识整理成可以重读的文字。',
    ...
    projects: {
      ...
      focus: {
        ...
        notes: ['这里留下值得持续维护的作品。', '过程、取舍与结果同样属于项目本身。'],
    ...
    learn: {
      ...
      focus: {
        ...
        notes: ['主题、章节与笔记构成学习轨道。', '每一次完成，都是下一次深入的坐标。'],
        action: 'ENTER LEARN',
      },
    },
  },
