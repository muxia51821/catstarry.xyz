...
assert.match(html, /还没有可用于曲线的历史估值/);
...
assert.doesNotMatch(script, /治理动作|canonical raw close|reconciliation anchor|不是历史曲线数据源/);
...
assert.match(script, /填写券商页面当前显示的证券市值、可用现金和其他账户资产/);
