...
def main(path: Path):
    sheets = {
        ...
        'Account Events': [['source_row','date','trade_time','record_kind','security_label_resolved','canonical_ticker','canonical_name','quantity','source_amount','net_cash_amount','position_category','source_note','review_note'], [1,46175,'09:00','dividend','测试ETF',510300,'测试ETF',0,10,10,'A股宽基指数底仓','红利',None], [2,46175,'14:32','repo_start','GC001','GC001','1天逆回购',80,-8000.01,-8000.01,'机动仓（货币ETF）','逆回购',None]],
