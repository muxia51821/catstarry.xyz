...
const fixtures = {
  ...
  '/api/pe': { indexes: [{ ticker: 'CSI300_PE', display_name: '沪深 300 PE-TTM', pe_ttm: 12.5, temperature: { zone: 'normal', suggestion: 'normal_dca' }, historical_position: { status: 'available', source: 'CSI', source_date: '2026-07-30', window_start: '2016-07-30', window_end: '2026-07-30', observation_count: 2410, percentile: .18, p20: 12.7, p50: 14.4, p80: 16.8, band: 'historical_low' } }, { ticker: 'CSI500_PE', display_name: '中证 500 PE-TTM', pe_ttm: 22.8, historical_position: { status: 'available', source: 'CSI', source_date: '2026-07-30', window_start: '2016-07-30', window_end: '2026-07-30', observation_count: 2410, percentile: .84, p20: 17.4, p50: 20.8, p80: 27.5, band: 'historical_high' } }, { ticker: 'CSI1000_PE', display_name: '中证 1000 PE-TTM', pe_ttm: 31.4, historical_position: { status: 'unavailable', reason: 'history_stale', source: 'CSI', source_date: '2026-07-20' } }, { ticker: 'STAR50_PE', display_name: '科创 50 PE-TTM', pe_ttm: 48.2, historical_position: { status: 'available', source: 'CSI', source_date: '2026-07-30', window_start: '2020-07-06', window_end: '2026-07-30', observation_count: 1460, percentile: .91, p20: 33.1, p50: 49.2, p80: 76, band: 'historical_high' } }, { ticker: 'NASDAQ100_PE', display_name: '纳斯达克 100 PE', pe_ttm: 36.1 }] },
