/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/feed-api/wrangler.jsonc workers/feed-api/worker-configuration.d.ts` (hash: 5b259d67690deddf6d80d311660aaa5a)
