/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/feed-api/wrangler.jsonc workers/feed-api/worker-configuration.d.ts` (hash: 4c96bea8ef4aa8e871f9c3320cd5eb10)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 global_fetch_strictly_public
interface __BaseEnv_Env {
	VIEW_KV: KVNamespace;
	AUTH_KV: KVNamespace;
	MEDIA_BUCKET: R2Bucket;
	HOME_PROJECTIONS: R2Bucket;
	DB: D1Database;
	AI: Ai;
}
